...
var descriptors = []Descriptor{
	{Name: "agent", Renderer: RendererSpecial, Docs: DocsDelegation, Access: AccessWrite, Builder: BuilderCoordinator, Writes: true, DefaultAllowed: true, Gate: GateAllowed},
	...
	{Name: "job_output", Renderer: RendererSpecial, Docs: DocsShell, Access: AccessRead, DefaultAllowed: true},
	{Name: "job_kill", Renderer: RendererDedicated, Docs: DocsShell, Access: AccessWrite, DefaultAllowed: true},
	{Name: "download", Renderer: RendererDedicated, Access: AccessWrite, Writes: true, Confined: true, DefaultAllowed: true, Docs: DocsWeb},
	...
	{Name: "fetch", Renderer: RendererDedicated, Access: AccessRead, Writes: true, DefaultAllowed: true, TaskReadOnly: true, Gate: GateAlways, Docs: DocsWeb},
	{Name: "agentic_fetch", Access: AccessWrite, Builder: BuilderCoordinator, Writes: true, DefaultAllowed: true, Gate: GateAllowed, Renderer: RendererSpecial, Docs: DocsWeb},
	{Name: "web_fetch", Renderer: RendererDedicated, Access: AccessRead, Writes: true, DefaultAllowed: true, TaskReadOnly: true, Docs: DocsWeb},
	{Name: "web_search", Renderer: RendererDedicated, Access: AccessRead, Writes: true, DefaultAllowed: true, TaskReadOnly: true, Docs: DocsWeb},
