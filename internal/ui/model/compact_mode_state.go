...
// compactModeState owns the in-flight lifecycle of compact-mode persistence.
...
func (s *compactModeState) begin() (generation uint64, started bool) {
	if s.loading {
		return 0, false
	}
	s.loading = true
...
func (s *compactModeState) complete(generation uint64) bool {
...
// isLoading reports whether a compact-mode write is in flight.
func (s *compactModeState) isLoading() bool {
	return s.loading
}
