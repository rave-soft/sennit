...
func TestYoloState_ZeroState(t *testing.T) {
	t.Parallel()
...
func TestYoloState_BeginRejectsWhileLoading(t *testing.T) {
	t.Parallel()
...
func TestYoloState_GenerationProgressesAfterConsumption(t *testing.T) {
	t.Parallel()
...
func TestYoloState_StaleResultPreservesLoading(t *testing.T) {
	t.Parallel()
...
func TestYoloState_MatchingResultConsumesLoading(t *testing.T) {
	t.Parallel()
