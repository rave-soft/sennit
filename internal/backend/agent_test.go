...
func (c *blockingCoordinator) RegisterDelegationParent(string, agent.DelegationParent) {}

func (c *blockingCoordinator) SendToParent(context.Context, string, string) error { return nil }
