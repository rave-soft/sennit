...
func (s *runCoordinator) DeliverTaskCompletion(context.Context, string, agent.TaskCompletion) {}
func (s *runCoordinator) RefreshSkills([]*skills.Skill, []*skills.Skill)                      {}
func (s *runCoordinator) RegisterDelegationParent(string, agent.DelegationParent)             {}
func (s *runCoordinator) SendToParent(context.Context, string, string) error                  { return nil }
