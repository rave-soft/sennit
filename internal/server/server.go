...
func (s *Server) installHandler() {
	...
	mux.HandleFunc("GET /v1/workspaces/{id}/sessions/batch/messages", c.handleGetWorkspaceSessionMessagesBatch)
	...
	mux.HandleFunc("GET /v1/workspaces/{id}/git/uncommitted", c.handleGetWorkspaceUncommittedFiles)
	...
	mux.HandleFunc("GET /v1/workspaces/{id}/threads", c.handleGetWorkspaceThreads)
