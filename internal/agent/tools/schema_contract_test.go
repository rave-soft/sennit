...
var schemaContracts = map[string]schemaContract{
	...
	"thread_create": {audited: true, empty: []string{"name", "goal"}}, "thread_merge": {audited: true, empty: []string{"id"}}, "thread_remove": {audited: true, empty: []string{"id"}},
	"agent_list": {audited: true, reason: "all filters are optional"}, "agent_result": {audited: true, empty: []string{"id"}}, "agent_cancel": {audited: true, empty: []string{"id"}}, "agent_send": {audited: true, empty: []string{"id", "message"}}, "agent_output": {audited: true, empty: []string{"id"}}, "ask_parent": {audited: true, empty: []string{"message"}},
}
