...
|---|---|---|
| 1.1 Legacy-импорт | частично | ``ON CONFLICT DO NOTHING`` уже ограничивает обработку конфликтами и прочие ошибки возвращаются — добавить отсутствующий тест на rollback при operational-error |
...
| 5.1 VCR/`TestCoderAgent` | частично | Режим записи выделен, но replay по умолчанию всё ещё skip и в CI не работает |
