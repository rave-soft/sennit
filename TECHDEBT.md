...
- **Хвосты ревью-раунда 3 (2026-08-23).** `REFACTORING-2026-08-23-r3.md`
  ...
  **Разбор продолжен 2026-08-29: 84 → 74, гнездо `internal/agent/tools`
  ...
  Остаётся 74, и один заметный пласт — фасад `internal/agent/tools/mcp`
  ...
  commands)» — их нет; исправлено. Разматывать стоит не ради чистоты:
  process-global реестр — это общее состояние между тестами, и именно
  оно мешает тестам этого пакета идти параллельно.
