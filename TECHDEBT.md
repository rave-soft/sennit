...
- **Хвосты ревью-раунда 3 (2026-08-23).** `REFACTORING-2026-08-23-r3.md`
  ...
  **Разбор доведён 2026-08-30: 84 → 65, и остаток классифицирован.**
  ...
  commands)» — их нет; исправлено. Это единственный пункт из остатка,
  который стоит разматывать, и не ради чистоты: process-global реестр —
  общее состояние между тестами, и именно оно мешает тестам этого пакета
  идти параллельно. Работа тут не в удалении шести обёрток, а в переводе
  тестов пакета на собственные реестры.
